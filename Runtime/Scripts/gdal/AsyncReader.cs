...
public class AsyncReader : global::System.IDisposable {
  ...
  public AsyncStatusType GetNextUpdatedRegion(double timeout, out int xoff, out int yoff, ref int buf_xsize, ref int buf_ysize) {
    AsyncStatusType ret = (AsyncStatusType)GdalPINVOKE.AsyncReader_GetNextUpdatedRegion(swigCPtr, timeout, out xoff, out yoff, ref buf_xsize, ref buf_ysize);
