...
public class GDALRasterizeOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALRasterizeOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALRasterizeOptions(tempoptions._ar);
    }
  }

  public GDALRasterizeOptions(string[] options) : this(GDALRasterizeOptions.SwigConstructGDALRasterizeOptions(options), true, null) {
