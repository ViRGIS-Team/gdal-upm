...
public class GDALFootprintOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALFootprintOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALFootprintOptions(tempoptions._ar);
    }
  }

  public GDALFootprintOptions(string[] options) : this(GDALFootprintOptions.SwigConstructGDALFootprintOptions(options), true, null) {
