...
public class GDALTranslateOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALTranslateOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALTranslateOptions(tempoptions._ar);
    }
  }

  public GDALTranslateOptions(string[] options) : this(GDALTranslateOptions.SwigConstructGDALTranslateOptions(options), true, null) {
