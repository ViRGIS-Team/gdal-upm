...
public class GDALTileIndexOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALTileIndexOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALTileIndexOptions(tempoptions._ar);
    }
  }

  public GDALTileIndexOptions(string[] options) : this(GDALTileIndexOptions.SwigConstructGDALTileIndexOptions(options), true, null) {
