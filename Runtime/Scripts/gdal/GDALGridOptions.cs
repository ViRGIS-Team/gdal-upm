...
public class GDALGridOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALGridOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALGridOptions(tempoptions._ar);
    }
  }

  public GDALGridOptions(string[] options) : this(GDALGridOptions.SwigConstructGDALGridOptions(options), true, null) {
