...
public class GDALVectorInfoOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALVectorInfoOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALVectorInfoOptions(tempoptions._ar);
    }
  }

  public GDALVectorInfoOptions(string[] options) : this(GDALVectorInfoOptions.SwigConstructGDALVectorInfoOptions(options), true, null) {
