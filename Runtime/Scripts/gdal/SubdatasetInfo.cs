...
public class SubdatasetInfo : global::System.IDisposable {
  ...
  IntPtr cPtr = GdalPINVOKE.SubdatasetInfo_GetPathComponent(swigCPtr);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = GdalPINVOKE.SubdatasetInfo_GetSubdatasetComponent(swigCPtr);
  string ret = GdalPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public string ModifyPathComponent(string pszNewFileName) {
    IntPtr temppszNewFileName = GdalPINVOKE.StringToUtf8Unmanaged(pszNewFileName);
    try {
    /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
    IntPtr cPtr = GdalPINVOKE.SubdatasetInfo_ModifyPathComponent(swigCPtr, temppszNewFileName);
    string ret = GdalPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
    
      if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
} finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(temppszNewFileName);
    }
  }
