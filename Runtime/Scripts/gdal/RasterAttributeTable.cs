...
public class RasterAttributeTable : global::System.IDisposable {
  ...
  IntPtr cPtr = GdalPINVOKE.RasterAttributeTable_GetNameOfCol(swigCPtr, iCol);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = GdalPINVOKE.RasterAttributeTable_GetValueAsString(swigCPtr, iRow, iCol);
  string ret = GdalPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public bool GetValueAsBoolean(int iRow, int iCol) {
    bool ret = GdalPINVOKE.RasterAttributeTable_GetValueAsBoolean(swigCPtr, iRow, iCol);
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public RATDateTime GetValueAsDateTime(int iRow, int iCol) {
    RATDateTime ret = new RATDateTime(GdalPINVOKE.RasterAttributeTable_GetValueAsDateTime(swigCPtr, iRow, iCol), true, null);
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void SetValueAsString(int iRow, int iCol, string pszValue) {
    ...
    try {
      GdalPINVOKE.RasterAttributeTable_SetValueAsString(swigCPtr, iRow, iCol, temppszValue);
      if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
    } finally {
  ...
  public void SetValueAsBoolean(int iRow, int iCol, bool value) {
    GdalPINVOKE.RasterAttributeTable_SetValueAsBoolean(swigCPtr, iRow, iCol, value);
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetValueAsDateTime(int iRow, int iCol, RATDateTime value) {
    GdalPINVOKE.RasterAttributeTable_SetValueAsDateTime(swigCPtr, iRow, iCol, RATDateTime.getCPtr(value));
    if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public int CreateColumn(string pszName, RATFieldType eType, RATFieldUsage eUsage) {
    ...
    try {
      int ret = GdalPINVOKE.RasterAttributeTable_CreateColumn(swigCPtr, temppszName, (int)eType, (int)eUsage);
      if (GdalPINVOKE.SWIGPendingException.Pending) throw GdalPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
