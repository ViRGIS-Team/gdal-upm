...
public class GDALBuildVRTOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALBuildVRTOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALBuildVRTOptions(tempoptions._ar);
    }
  }

  public GDALBuildVRTOptions(string[] options) : this(GDALBuildVRTOptions.SwigConstructGDALBuildVRTOptions(options), true, null) {
