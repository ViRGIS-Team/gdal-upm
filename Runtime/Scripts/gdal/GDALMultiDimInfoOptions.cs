...
public class GDALMultiDimInfoOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALMultiDimInfoOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALMultiDimInfoOptions(tempoptions._ar);
    }
  }

  public GDALMultiDimInfoOptions(string[] options) : this(GDALMultiDimInfoOptions.SwigConstructGDALMultiDimInfoOptions(options), true, null) {
