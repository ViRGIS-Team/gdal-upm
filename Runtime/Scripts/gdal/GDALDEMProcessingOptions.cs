...
public class GDALDEMProcessingOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALDEMProcessingOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALDEMProcessingOptions(tempoptions._ar);
    }
  }

  public GDALDEMProcessingOptions(string[] options) : this(GDALDEMProcessingOptions.SwigConstructGDALDEMProcessingOptions(options), true, null) {
