...
public class GDALWarpAppOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALWarpAppOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALWarpAppOptions(tempoptions._ar);
    }
  }

  public GDALWarpAppOptions(string[] options) : this(GDALWarpAppOptions.SwigConstructGDALWarpAppOptions(options), true, null) {
