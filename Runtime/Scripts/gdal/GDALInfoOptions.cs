...
public class GDALInfoOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALInfoOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALInfoOptions(tempoptions._ar);
    }
  }

  public GDALInfoOptions(string[] options) : this(GDALInfoOptions.SwigConstructGDALInfoOptions(options), true, null) {
