...
public class GDALNearblackOptions : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGDALNearblackOptions(string[] options) {
    using (var tempoptions = new GdalPINVOKE.StringListMarshal(options)) { 
    return GdalPINVOKE.new_GDALNearblackOptions(tempoptions._ar);
    }
  }

  public GDALNearblackOptions(string[] options) : this(GDALNearblackOptions.SwigConstructGDALNearblackOptions(options), true, null) {
