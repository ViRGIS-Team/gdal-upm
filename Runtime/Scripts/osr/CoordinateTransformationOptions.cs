...
public class CoordinateTransformationOptions : global::System.IDisposable {
  ...
  public bool SetOperation(string operation, bool inverseCT) {
    IntPtr tempoperation = OsrPINVOKE.StringToUtf8Unmanaged(operation);
    try {
      bool ret = OsrPINVOKE.CoordinateTransformationOptions_SetOperation(swigCPtr, tempoperation, inverseCT);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempoperation);
    }
  }
