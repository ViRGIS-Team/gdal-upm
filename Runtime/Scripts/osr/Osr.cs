...
public class Osr {
  ...
  public static void StringListDestroy(IntPtr string_list_ptr) {
    OsrPINVOKE.StringListDestroy(string_list_ptr);
  ...
  internal static void CPLMemDestroy(IntPtr buffer_ptr) {
    OsrPINVOKE.CPLMemDestroy(buffer_ptr);
    if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
  }
...
public delegate int GDALProgressFuncDelegate(double Complete, IntPtr Message, IntPtr Data);
  public static CRSInfoList GetCRSInfoListFromDatabase(string authName, out int pnListCount) {
    IntPtr tempauthName = OsrPINVOKE.StringToUtf8Unmanaged(authName);
    try {
      IntPtr cPtr = OsrPINVOKE.GetCRSInfoListFromDatabase(tempauthName, out pnListCount);
      CRSInfoList ret = (cPtr == IntPtr.Zero) ? null : new CRSInfoList(cPtr, true, ThisOwn_true());
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempauthName);
    }
  }
  ...
  public static int GetWellKnownGeogCSAsWKT(string name, out string argout) {
    ...
    try {
      int ret = OsrPINVOKE.GetWellKnownGeogCSAsWKT(tempname, ref tempargout);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
  ...
  public static int GetUserInputAsWKT(string name, out string argout) {
    ...
    IntPtr tempargout = IntPtr.Zero;
    try {
      int ret = OsrPINVOKE.GetUserInputAsWKT(tempname, ref tempargout);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempname);
  ...
  IntPtr cPtr = OsrPINVOKE.OSRAreaOfUse_name_get(AreaOfUse.getCPtr(area));
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_auth_name_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_code_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_name_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_area_name_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_projection_method_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public static string OSRCRSInfo_celestial_body_name_get(CRSInfo crsInfo) {
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OsrPINVOKE.OSRCRSInfo_celestial_body_name_get(CRSInfo.getCPtr(crsInfo));
  string ret = OsrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public static string[] GetAuthorityListFromDatabase() {
  ...
  IntPtr cPtr = OsrPINVOKE.GetAuthorityListFromDatabase();
  IntPtr objPtr;
  int count = 0;
  if (cPtr != IntPtr.Zero) {
...
/*@SWIG@*/
  ...
  public static void SetPROJSearchPath(string utf8_string) {
    IntPtr temputf8_string = OsrPINVOKE.StringToUtf8Unmanaged(utf8_string);
    try {
      OsrPINVOKE.SetPROJSearchPath(temputf8_string);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
    } finally {
  ...
  public static void SetPROJSearchPaths(string[] paths) {
    using (var temppaths = new OsrPINVOKE.StringListMarshal(paths)) { 
    {
      OsrPINVOKE.SetPROJSearchPaths(temppaths._ar);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
    }
    }
  }
...
/*@SWIG@*/
  ...
  public static void SetPROJAuxDbPath(string utf8_string) {
    IntPtr temputf8_string = OsrPINVOKE.StringToUtf8Unmanaged(utf8_string);
    try {
      OsrPINVOKE.SetPROJAuxDbPath(temputf8_string);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(temputf8_string);
    }
  ...
  public static void SetPROJAuxDbPaths(string[] paths) {
    using (var temppaths = new OsrPINVOKE.StringListMarshal(paths)) { 
    {
      OsrPINVOKE.SetPROJAuxDbPaths(temppaths._ar);
      if (OsrPINVOKE.SWIGPendingException.Pending) throw OsrPINVOKE.SWIGPendingException.Retrieve();
    }
    }
  }
