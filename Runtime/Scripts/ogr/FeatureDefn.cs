...
public class FeatureDefn : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructFeatureDefn(string name_null_ok) {
    IntPtr tempname_null_ok = OgrPINVOKE.StringToUtf8Unmanaged(name_null_ok);
    try {
      return OgrPINVOKE.new_FeatureDefn(tempname_null_ok);
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempname_null_ok);
    }
  }

  public FeatureDefn(string name_null_ok) : this(FeatureDefn.SwigConstructFeatureDefn(name_null_ok), true, null) {
  ...
  public int GetFieldIndex(string field_name) {
    ...
    try {
      int ret = OgrPINVOKE.FeatureDefn_GetFieldIndex(swigCPtr, tempfield_name);
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
  ...
  public int GetGeomFieldIndex(string field_name) {
    IntPtr tempfield_name = OgrPINVOKE.StringToUtf8Unmanaged(field_name);
    try {
      int ret = OgrPINVOKE.FeatureDefn_GetGeomFieldIndex(swigCPtr, tempfield_name);
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempfield_name);
