...
public class GeomFieldDefn : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGeomFieldDefn(string name_null_ok, wkbGeometryType field_type) {
    IntPtr tempname_null_ok = OgrPINVOKE.StringToUtf8Unmanaged(name_null_ok);
    try {
      return OgrPINVOKE.new_GeomFieldDefn(tempname_null_ok, (int)field_type);
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempname_null_ok);
    }
  }

  public GeomFieldDefn(string name_null_ok, wkbGeometryType field_type) : this(GeomFieldDefn.SwigConstructGeomFieldDefn(name_null_ok, field_type), true, null) {
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OgrPINVOKE.GeomFieldDefn_GetNameRef(swigCPtr);
  string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public void SetName(string name) {
    ...
    try {
      OgrPINVOKE.GeomFieldDefn_SetName(swigCPtr, tempname);
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    } finally {
