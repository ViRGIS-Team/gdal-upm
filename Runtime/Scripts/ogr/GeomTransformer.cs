...
public class GeomTransformer : global::System.IDisposable {
  ...
  static private global::System.IntPtr SwigConstructGeomTransformer(OSGeo.OSR.CoordinateTransformation ct, string[] options) {
    using (var tempoptions = new OgrPINVOKE.StringListMarshal(options)) { 
    return OgrPINVOKE.new_GeomTransformer(OSGeo.OSR.CoordinateTransformation.getCPtr(ct), tempoptions._ar);
    }
  }

  public GeomTransformer(OSGeo.OSR.CoordinateTransformation ct, string[] options) : this(GeomTransformer.SwigConstructGeomTransformer(ct, options), true, null) {
