...
public int ExportToWkb( byte[] buffer, wkbByteOrder byte_order ) {
  ...
  static private global::System.IntPtr SwigConstructGeometry(wkbGeometryType type, string wkt, int wkb, IntPtr wkb_buf, string gml) {
    IntPtr tempwkt = OgrPINVOKE.StringToUtf8Unmanaged(wkt);
    IntPtr tempgml = OgrPINVOKE.StringToUtf8Unmanaged(gml);
    try {
      return OgrPINVOKE.new_Geometry((int)type, tempwkt, wkb, wkb_buf, tempgml);
    } finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempwkt);
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempgml);
    }
  }

  public Geometry(wkbGeometryType type, string wkt, int wkb, IntPtr wkb_buf, string gml) : this(Geometry.SwigConstructGeometry(type, wkt, wkb, wkb_buf, gml), true, null) {
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public int ExportToWkt(out string argout) {
    ...
    try {
      int ret = OgrPINVOKE.Geometry_ExportToWkt(swigCPtr, ref tempargout);
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    argout = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(tempargout);
    }
  }
  ...
  public int ExportToIsoWkt(out string argout) {
    IntPtr tempargout = IntPtr.Zero;
    try {
      int ret = OgrPINVOKE.Geometry_ExportToIsoWkt(swigCPtr, ref tempargout);
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
    argout = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(tempargout);
  ...
  IntPtr cPtr = OgrPINVOKE.Geometry_ExportToGML__SWIG_0(swigCPtr);
  ...
  public string ExportToGML(string[] options) {
    ...
    {
    /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
    IntPtr cPtr = OgrPINVOKE.Geometry_ExportToGML__SWIG_1(swigCPtr, tempoptions._ar);
    string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public string ExportToKML(string altitude_mode) {
    IntPtr tempaltitude_mode = OgrPINVOKE.StringToUtf8Unmanaged(altitude_mode);
    try {
    /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
    IntPtr cPtr = OgrPINVOKE.Geometry_ExportToKML(swigCPtr, tempaltitude_mode);
    string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
    
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
} finally {
    System.Runtime.InteropServices.Marshal.FreeHGlobal(tempaltitude_mode);
    }
  }
  ...
  public string ExportToJson(string[] options) {
    ...
    {
    /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
    IntPtr cPtr = OgrPINVOKE.Geometry_ExportToJson(swigCPtr, tempoptions._ar);
    string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public int AddPoint(double x, double y, double z) {
    int ret = OgrPINVOKE.Geometry_AddPoint(swigCPtr, x, y, z);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int AddPointM(double x, double y, double m) {
    int ret = OgrPINVOKE.Geometry_AddPointM(swigCPtr, x, y, m);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int AddPointZM(double x, double y, double z, double m) {
    int ret = OgrPINVOKE.Geometry_AddPointZM(swigCPtr, x, y, z, m);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int AddPoint_2D(double x, double y) {
    int ret = OgrPINVOKE.Geometry_AddPoint_2D(swigCPtr, x, y);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OgrPINVOKE.Geometry_GetGeometryName(swigCPtr);
  string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public double GeodesicLength() {
    double ret = OgrPINVOKE.Geometry_GeodesicLength(swigCPtr);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int SetPoint(int point, double x, double y, double z) {
    int ret = OgrPINVOKE.Geometry_SetPoint(swigCPtr, point, x, y, z);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int SetPointM(int point, double x, double y, double m) {
    int ret = OgrPINVOKE.Geometry_SetPointM(swigCPtr, point, x, y, m);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int SetPointZM(int point, double x, double y, double z, double m) {
    int ret = OgrPINVOKE.Geometry_SetPointZM(swigCPtr, point, x, y, z, m);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int SetPoint_2D(int point, double x, double y) {
    int ret = OgrPINVOKE.Geometry_SetPoint_2D(swigCPtr, point, x, y);
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Geometry ConstrainedDelaunayTriangulation() {
    IntPtr cPtr = OgrPINVOKE.Geometry_ConstrainedDelaunayTriangulation(swigCPtr);
    Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Geometry BuildArea() {
    IntPtr cPtr = OgrPINVOKE.Geometry_BuildArea(swigCPtr);
    Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Geometry ConcaveHullOfPolygons(double lengthRatio, bool isTight, bool allowHoles) {
    IntPtr cPtr = OgrPINVOKE.Geometry_ConcaveHullOfPolygons(swigCPtr, lengthRatio, isTight, allowHoles);
    Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public Geometry MakeValid(string[] options) {
    using (var tempoptions = new OgrPINVOKE.StringListMarshal(options)) { 
    {
      IntPtr cPtr = OgrPINVOKE.Geometry_MakeValid(swigCPtr, tempoptions._ar);
      Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  ...
  public Geometry Buffer(double distance, int quadsecs) {
    IntPtr cPtr = OgrPINVOKE.Geometry_Buffer__SWIG_0(swigCPtr, distance, quadsecs);
    Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
    if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public Geometry Buffer(double distance, string[] options) {
    using (var tempoptions = new OgrPINVOKE.StringListMarshal(options)) { 
    {
      IntPtr cPtr = OgrPINVOKE.Geometry_Buffer__SWIG_1(swigCPtr, distance, tempoptions._ar);
      Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  ...
  /* %typemap(csout) (char *), (char *&), (char[ANY]), (char[]), (const char *utf8_string) */
  IntPtr cPtr = OgrPINVOKE.Geometry_GetInvalidityReason(swigCPtr);
  string ret = OgrPINVOKE.LengthPrefixedUtf16UnmanagedToString(cPtr);
  ...
  public Geometry GetLinearGeometry(double dfMaxAngleStepSizeDegrees, string[] options) {
    using (var tempoptions = new OgrPINVOKE.StringListMarshal(options)) { 
    {
      IntPtr cPtr = OgrPINVOKE.Geometry_GetLinearGeometry(swigCPtr, dfMaxAngleStepSizeDegrees, tempoptions._ar);
      Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
  ...
  public Geometry GetCurveGeometry(string[] options) {
    using (var tempoptions = new OgrPINVOKE.StringListMarshal(options)) { 
    {
      IntPtr cPtr = OgrPINVOKE.Geometry_GetCurveGeometry(swigCPtr, tempoptions._ar);
      Geometry ret = (cPtr == IntPtr.Zero) ? null : new Geometry(cPtr, true, ThisOwn_true());
      if (OgrPINVOKE.SWIGPendingException.Pending) throw OgrPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
